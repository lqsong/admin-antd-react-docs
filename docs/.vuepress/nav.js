module.exports = [
    ...
    },
    {
		...
		items: [
            ...
            {text: 'electron-admin-antd-react', link: '/guide/senior/electron'},
            {text: 'admin-vue3-micro-qiankun', link: 'http://admin-vue3-micro-qiankun.liqingsong.cc'},
        ]
    },
    {
        text: '预览', link: 'http://demo.admin-antd-react.liqingsong.cc'
    },
    {
        text: 'GitHub',
		items: [
            {text: 'Github', link: 'https://github.com/lqsong/admin-antd-react'},
            {text: 'Gitee', link: 'https://gitee.com/lqsong/admin-antd-react'},
        ]
    }
]